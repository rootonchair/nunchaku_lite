...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark original Diffusers Flux against nunchaku_lite Flux.")
    parser.add_argument("--model-id", default=DEFAULT_MODEL_ID)
    parser.add_argument("--checkpoint", default=DEFAULT_CHECKPOINT)
    parser.add_argument("--local-diffusers-src", default=None)
    parser.add_argument("--output-dir", default="outputs/benchmark_flux")
